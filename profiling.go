...
var errProfilingInfoEmpty = errors.New("no profiling information available for this connection")
...
func GetProfilingInfo(c *Conn) (ProfilingInfo, error) {
	info := ProfilingInfo{}
	duckdbInfo := C.duckdb_get_profiling_info(c.duckdbCon)
	if duckdbInfo == nil {
