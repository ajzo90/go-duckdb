...
deps.darwin.arm64: duckdb
	...
	cd duckdb && \
	OVERRIDE_GIT_DESCRIBE=v1.0.1-dev2074-5ebd8ca697 CFLAGS="-target arm64-apple-macos11 -O3" CXXFLAGS="-target arm64-apple-macos11 -O3" ${DUCKDB_COMMON_BUILD_FLAGS}  make bundle-library -j 2
